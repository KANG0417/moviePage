...
const key = "6058bbe97cc057987d5101e107d2daa2";
...
const fetchMovie = async() => {
  fetch('https://api.themoviedb.org/3/discover/movie?include_adult=false&include_video=false&language=ko-KR&page=3&sort_by=popularity.desc', options)
